...
const timelineData = [
  {
    date: '2025 - Present',
    title: 'Frontend & AI Development',
    sub: 'B.Tech CSE - 2nd Year',
    desc: 'Bridging modern frontend technologies with AI models. Actively building dynamic, user-centric applications while exploring machine learning algorithms and data science paradigms.',
    icon: BookOpen,
  ...
  },
  {
    ...
    sub: 'LetsUpgrade Certification & Projects',
    desc: 'Completed an intensive Python bootcamp, mastering object-oriented design, syntax architectures, and building real-world projects that solve practical problems efficiently.',
    icon: Award,
    color: 'from-indigo-500/20 to-purple-500/20 border-indigo-500/30 text-indigo-400',
  },
  {
    date: '2023 - Present',
    title: 'Core Computer Science Foundation',
    sub: 'Academic & Competitive Programming',
    desc: 'Mastered foundational languages including C, Java, and Python. Consistently solving complex algorithmic challenges on HackerRank and CodeChef to forge strong analytical and logic-building skills.',
    icon: GraduationCap,
